...
class IVSDatasetMapper:
    ...
    def __init__(self, cfg):
        ...
        self.pixel_mean = torch.tensor([123.675, 116.28, 103.53], dtype=torch.float32).view(-1, 1, 1)
        self.pixel_std = torch.tensor([58.395, 57.12, 57.375], dtype=torch.float32).view(-1, 1, 1)
